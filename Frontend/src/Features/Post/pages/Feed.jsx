...
const Feed = () => {
  ...
  const { fullname = "Clickly Member", profileImage = "" } = user || {};
  ...
  return (
    <div className="feed-container">
      ...
      <header className="mobile-top-header">
        <h1 className="logo-text">Clickly</h1>
        <button className="icon-btn" aria-label="Messages" onClick={() => setActiveTab("Messages")}>
      ...
      <nav className="mobile-bottom-nav">
        ...
        <button className="mobile-nav-item fab" onClick={() => setIsModalOpen(true)} aria-label="Create Post">
